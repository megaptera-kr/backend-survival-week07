...
public class CommentController {
    ...
    @GetMapping
    public List<CommentDto> commentDtos(@RequestParam String postId) {
    ...
    public void create(@RequestParam String postId, CommentCreateDto commentCreateDto) {
        createCommentService.createComment(postId, commentCreateDto);
    }

    @PatchMapping("/{id}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void update(@PathVariable String id, @RequestParam String postId, CommentUpdateDto commentUpdateDto) {
